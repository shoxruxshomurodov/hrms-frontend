...
class View extends Component {
  ...
  onDelete = (id) => {
    ...
    Swal.fire({
      title: t("Do you want to delete this district ?"),
      showDenyButton: true,
  ...
  onLink = (districtId) => {
    ...
    callToLink({ iabsCode, districtId });
  };
        ...
        <div className="flex-display-more">
          <Breadcrumb
            titles={[
              ...
              { id: 3, title: t("View"), url: "/district" },
              { id: 4, title: get(result, "title"), url: "" }
            ]}
          />
          <div>
            <Link
              to={`/district/update/${get(result, "id")}`}
              ...
              <div className="media-body g-brd-around g-brd-gray-light-v4 g-pa-30">
                <div className="g-mb-15">
                  ...
                  <h5 className="d-flex justify-content-between align-items-center h5 mb-0">
                    <span className="d-block g-mr-10">
                      {t("Country Title")} :{" "}
                      {get(result, "region.country.title")}
                    </span>
                  </h5>
                  <h5 className="d-flex justify-content-between align-items-center h5 mb-0">
                    <span className="d-block g-mr-10">
...
const mapStateToProps = (state) => {
  return {
    drawToRender: get(state, "normalizer.data.district-one.result", []),
    isFetched: get(state, "normalizer.data.district-one.isFetched", false),
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    callToLink: (attributes) => {
      dispatch({
        type: Actions.LINK_ABS_DISTRICT_TO_CORE_DISTRICT.REQUEST,
        payload: {
          attributes,
          cb: {
            success: () => {
