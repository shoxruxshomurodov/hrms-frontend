...
const DocumentBranchCandidateCreateContainer = ({
                                     t,
                                     entities,
                                     getProcessList,
                                     processes,
        ...
        if (get(formsWithFields, 'result')?.length > 0) {
            get(formsWithFields, 'result', []).map((form, index) => {
                ...
                arrForms.push(<Form key={index}
                                    ...
                                    cancelLink={"/DocumentBranchCandidate"}
                                    buttonText={t("Send")}
    ...
    return (
        <>
            <Breadcrumb
                titles={[
                    {id: 1, title: t("Document branch candidates"), url: "/DocumentBranchCandidate"},
    ...
    return {
        getProcessList: () => {
            ...
            dispatch({
                ...
                payload: {
                    ...
                    config: {
                        params: {
                            entity: 'DocumentBranchCandidate',
                            isCanStart: true
                        }
                    },
        ...
        createDocumentRequest: ({bpmnProcessName, formData}) => dispatch({
            ...
            payload: {
                ...
                url:"document-branch-candidate/create/start-new-process",
                cb: {
                    success: (nData, data) => {
                        toast.dismiss();
...
export default withTranslation("HRMS")(connect(mapStateToProps, mapDispatchToProps)(DocumentBranchCandidateCreateContainer));
