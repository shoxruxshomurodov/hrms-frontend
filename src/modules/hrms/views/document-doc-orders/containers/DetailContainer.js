...
const DetailContainer = ({
    ...
    document = Normalizer.Denormalize(document, DocOrderScheme, entities);
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getDocument: (id) => {
            ...
            const entityName = "DocumentDocOrders";
            const scheme = DocOrderScheme;
            dispatch({
                type: ApiActions.GET_ONE.REQUEST,
                payload: {
                    url: `document-doc-orders/${id}`,
                    scheme,
                    storeName,
                    entityName
                }
