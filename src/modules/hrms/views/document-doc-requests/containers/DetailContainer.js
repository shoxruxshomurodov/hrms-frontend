...
import {find, get, head, isArray, isEmpty, isEqual, isNil, split, trim} from "lodash";
...
import DocOrderScheme from "../../../../../schema/DocOrderScheme";
...
const DetailContainer = ({
    ...
    document = Normalizer.Denormalize(document, DocRequestScheme, entities);
    ...
    return {
        ...
        triggerDocs: () => {
            dispatch({
                ...
                payload: {
                    storeName: "get-document-all",
                },
            });
        },
        getDocument: (id) => {
            const storeName = "get-document-one";
            const entityName = "DocumentDocRequests";
            const scheme = DocRequestScheme;
            dispatch({
                type: ApiActions.GET_ONE.REQUEST,
                payload: {
                    url: `document-doc-requests/${id}`,
                    scheme,
                    storeName,
                    entityName
                }
