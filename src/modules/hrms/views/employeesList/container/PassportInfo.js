...
function PassportInfo({t,user,hasAction = false}) {
    ...
    const attributes = [
        ...
        {label: t("passport"), value: get(passport, 'docSeries') + get(passport, 'docNumber')},
            ...
            <div> 
                <div className='row'>
                    <div className='col col-12'>
                        <Tabs titles={[ t("Passport Info"), t("Address Info")]}
                              texts={[
                                  <>
                                 ...
                                 </>:<ContentLoader /> }</>, <AddressInfo hasAction={hasAction} user={user}/>]}
                    />
                    </div>
