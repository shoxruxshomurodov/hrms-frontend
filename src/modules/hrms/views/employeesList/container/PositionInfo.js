...
function PositionInfo({userExperiences,currentPosition}) {
          ...
          <li className="col-md-12 g-mb-40">
            <div className="row">
              ...
              <div className="col-md-3 text-md-right g-pt-20--md g-pr-40--md g-mb-20">
                <h5 className="h6 g-font-weight-700 mb-0">{get(currentPosition, 'startDate')}</h5>
                <h4 className="h4 g-font-weight-300">{get(currentPosition, 'companyName')} </h4>
              </div>
              {/* End Timeline Date */}
              {/* Timeline Content */}
              <div className="col-md-9 g-orientation-left g-pl-40--md">
                ...
                <article className="g-pos-rel g-bg-gray-light-v5 g-pa-30">
                  ...
                  <header className="g-brd-bottom g-brd-gray-light-v4 g-pb-10 g-mb-25">
                    <h3 className="g-font-weight-300">{get(currentPosition,"structureName")}</h3>
                  </header>
              ...
              <li className="col-md-12 g-mb-40">
                <div className="row">
                  ...
                  <div className="col-md-3 text-md-right g-pt-20--md g-pr-40--md g-mb-20">
                    ...
                    <h4 className="h4 g-font-weight-300">{get(experience, 'companyName')}</h4>
                  </div>
                  {/* End Timeline Date */}
                  {/* Timeline Content */}
                  <div className="col-md-9 g-orientation-left g-pl-40--md">
                    ...
                    <article className="g-pos-rel g-bg-gray-light-v5 g-pa-30">
                      ...
                      {/* End Timeline Arrow */}
                      <header className="g-brd-bottom g-brd-gray-light-v4 g-pb-10 g-mb-25">
                        <h3 className="g-font-weight-300">{get(experience,"structureName")}</h3>
                      </header>
                      <p className="lead g-mb-25">
