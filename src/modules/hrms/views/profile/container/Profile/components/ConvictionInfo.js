      ...
      {!isFetched ? (
        <div>
          {!isNil(get(user, "employeeReference.conviction", null)) && (
            <>
              <h2 className="h4 g-font-weight-300">
                {get(user, "employeeReference.conviction.title", null)}
              </h2>
              <div id="shortcode4">
                <div className="shortcode-html">
                  <div
                    className={classNames(
                      "g-brd-around g-brd-gray-light-v4 g-brd-2  g-line-height-1_8 g-pa-30 g-mb-30",
                      {
                        "g-brd-green-top": !get(
                          user,
                          "employeeReference.conviction.isFound",
                          false
                        ),
                        "g-brd-red-top": get(
                          user,
                  ...
                  >
                    ...
                    >
                      {get(user, "employeeReference.conviction.response", null)}{" "}
                    </h3>
                    <p className="mb-0">
              ...
              {isEqual(
                get(user, "employeeReference.conviction.file.extension"),
                "pdf"
              ) && (
                <PDFViewer
                  pdf={get(user, "employeeReference.conviction.file.url")}
                />
              )}
            </>
          )}
          ...
          <div className={"text-sm-right g-mt-30"}>
            ...
            {!isNil(get(user, "employeeReference.conviction", null)) && (
              <a
                href={get(user, "employeeReference.conviction.file.url", "#")}
                className={
...
export default withTranslation("HRMS")(
  connect(mapStateToProps, mapDispatchToProps)(ConvictionInfo)
);
