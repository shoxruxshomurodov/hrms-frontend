...
const HistoryPositionInfo = ({ t, user }) => {
      ...
      <div>
        <div className="row">
          <div className="col col-12">
            <Tabs
              titles={["Position history info", "Position info"]}
              texts={[
                <>
                  {!isFetched ? (
                    <div>
                                ...
                                >
                                  <div className="row">
                                    <div className="col-md-3 text-md-right g-pt-20--md g-pr-40--md g-mb-20">
                                      ...
                                      <h4 className="h5 g-font-weight-200">
