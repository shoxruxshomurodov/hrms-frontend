...
const ProfileInfo = ({ user = {},profile={}, avatar, t, }) => {
  const findAvatar = isEqual(get(user,"employeesPassport.gender"), "MALE") ? man1 : woman1;
  const [showPhoneNumber, setShowPhoneNumber] = useState(false);
  console.log('useruser',profile)
  return (
    <>
      <div className="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
        <div className="row">
          ...
          <div className="col-lg-8">
            ...
            <hr className="g-brd-gray-light-v4 g-my-20" />
            {/*<p className="lead g-line-height-1_8">*/}
            {/*  {get(profile, "authorities",[]).map(role => <span>{`${role}, `}</span>)}*/}
            {/*</p>*/}
